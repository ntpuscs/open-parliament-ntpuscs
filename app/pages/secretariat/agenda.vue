...
const generatedAgenda = ref(''); // 顯示生成的議程文字

// 當議案資料或輸入順序改變時，重新生成議程
...
<template>
  <div class="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4 font-inter">
    <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-2xl">
      <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">安排議程</h1>
      ...
      <div class="mb-6">
        ...
        <textarea id="agendaOutput" rows="15" readonly :value="generatedAgenda"
          class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
      </div>
